...
public class MainOps {
    public static void main(String[] args) {
        ...
        OperationsBox<String> stringOperationsBox = new OperationsBox<String>(s1, s2);
        System.out.println(stringOperationsBox);
        System.out.println(stringOperationsBox.getOperand1());
        System.out.println(stringOperationsBox.getOperand2());

        Integer i1 = 1;
        Integer i2 = 2;
        OperationsBox<Integer> integerOperationsBox = new OperationsBox<Integer>(i1, i2);
        System.out.println(integerOperationsBox);
